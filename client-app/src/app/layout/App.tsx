...
function App() {
  ...
  useEffect(function () {
    agent.Activities.list().then(function (response) {
  ...
  function handleSelectActivity(id: string) {
    agent.Activities.details(id).then(function (response) {
  ...
  if (loading) return <LoadingComponents content="Loadding app" />;
